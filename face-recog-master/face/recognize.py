	...
	while True:
		...
		for (x, y, w, h) in faces:
			...
			if conf>=65:
				...
				cv2.rectangle(frame, (x-stroke, y), (end_cord_x+stroke, end_cord_y-h-text_height-stroke-20), red_color, cv2.FILLED)
				cv2.putText(frame, name, (text_offset_x, text_offset_y-5), font, fontscale, white_color, stroke, cv2.LINE_AA)
